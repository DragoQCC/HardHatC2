...
//
//             IntPtr pImage = h_DynInv_Methods.NtFuncWrapper.NtAllocateVirtualMemory(
...
//             IntPtr pCallStub = h_DynInv_Methods.NtFuncWrapper.NtAllocateVirtualMemory(
//                 (IntPtr)(-1), ref BaseAddress, IntPtr.Zero, ref RegionSize,
//                 Win32.Kernel32.AllocationType.Commit | Win32.Kernel32.AllocationType.Reserve,
//                 Win32.WinNT.PAGE_READWRITE
//             );
...
//             h_DynInv_Methods.NtFuncWrapper.NtProtectVirtualMemory((IntPtr)(-1), ref pCallStub, ref RegionSize, Win32.WinNT.PAGE_EXECUTE_READ);
//
//             // Free temporary allocations
//             Marshal.FreeHGlobal(pModule);
//             RegionSize = PEINFO.Is32Bit ? (IntPtr)PEINFO.OptHeader32.SizeOfImage : (IntPtr)PEINFO.OptHeader64.SizeOfImage;
//
//             h_DynInv_Methods.NtFuncWrapper.NtFreeVirtualMemory((IntPtr)(-1), ref pImage, ref RegionSize, Win32.Kernel32.AllocationType.Reserve);
//
//             return pCallStub;
//         }
//
...
//             h_DynInv_Methods.NtFuncWrapper.NtProtectVirtualMemory((IntPtr)(-1), ref ModuleMemoryBase, ref BaseOfCode, Win32.WinNT.PAGE_READONLY);
//
...
//
//                 // Set protection
//                 h_DynInv_Methods.NtFuncWrapper.NtProtectVirtualMemory((IntPtr)(-1), ref pVirtualSectionBase, ref ProtectSize, flNewProtect);
//             }
//         }
//
//         /// <summary>
...
//
//                 h_DynInv_Methods.NtFuncWrapper.NtFreeVirtualMemory((IntPtr)(-1), ref pModule, ref size, Win32.Kernel32.AllocationType.Release);
//             }
//         }
//
//         /// <summary>
...
//             h_DynInv_Methods.NtFuncWrapper.NtProtectVirtualMemory((IntPtr)(-1), ref DecoyMetaData.ModuleBase, ref RegionSize, Win32.WinNT.PAGE_READWRITE);
//
//             // Zero out memory
