...
//                    Opsec = OpsecStatus.NotSet,
//                    MitreTechnique = "",
//                    Details = "Controls the data chunking settings, and retrieves the current settings and module status, execute with no flags to get the current setting and status",
//                    Keys = "/enable - enables data chunking so task response will be split into chunks of bytes at the size set \n/disable - stop command responses from being chunked \n/size - the size to break the command response into in bytes"
//                },
//                new HelpMenuItem()
//                {
//                    Name = "delete",
...
//                    Opsec = OpsecStatus.NotSet,
//                    MitreTechnique = "",
//                    Details = "returns the current engineers loaded Modules, new Modules can be added with AddModule",
//                    Keys = ""
//                },
//                 new HelpMenuItem()
//                 {
