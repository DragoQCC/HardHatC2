...
namespace DynamicEngLoading
{
    ...
    public class h_DynInv_Methods
    {
        public class NtFuncWrapper
        {
            ...
            public static IntPtr NtAllocateVirtualMemory(IntPtr ProcessHandle,int length, Win32.Kernel32.AllocationType AllocationType, UInt32 Protect)
            {
                try
                {
                ...
                {
                    Console.WriteLine("Memory allocation failed, error: " + ex.Message);
                    return IntPtr.Zero;
                }
                
            }

            public static void NtFreeVirtualMemory(IntPtr ProcessHandle, ref IntPtr BaseAddress, int length, Win32.Kernel32.AllocationType FreeType)
            {
            ...
            public static string GetFilenameFromMemoryPointer(IntPtr hProc, IntPtr pMem)
            {
                ...
                int RegionSize = (int)0x500;
                IntPtr pAlloc = NtAllocateVirtualMemory(hProc,RegionSize,Win32.Kernel32.AllocationType.Commit | Win32.Kernel32.AllocationType.Reserve, Win32.WinNT.PAGE_READWRITE);
                ...
                // Free allocation
                NtFreeVirtualMemory(hProc, ref pAlloc,RegionSize, Win32.Kernel32.AllocationType.Reserve);
                if (retValue == NTSTATUS.AccessDenied)
                {
                    // STATUS_ACCESS_DENIED
                    throw new UnauthorizedAccessException("Access is denied.");
            ...
            public static UInt32 NtProtectVirtualMemory(IntPtr ProcessHandle, ref IntPtr BaseAddress,int length, UInt32 NewProtect)
            {
                // Craft an array for the arguments
                UInt32 OldProtect = 0;
                var regionSize = new IntPtr(length);
            ...
            //func wrapper for NtWaitForSingleObject
            public static uint NtWaitForSingleObject(IntPtr hHandle, bool Alertable, IntPtr Timeout)
            {
                object[] funcargs = { hHandle, Alertable, Timeout };
                var result = (uint)DynInv.DynamicAPIInvoke("ntdll.dll", @"NtWaitForSingleObject", typeof(NT_DELEGATES.NtWaitForSingleObject), ref funcargs);
                return result;
            }
        ...
        {
            //func wrapper for DynInv AllocConsole
            public static void AllocConsole()
            {
                object[] parameters = { };
                DynInv.DynamicAPIInvoke("kernel32.dll", "AllocConsole", typeof(KER32_DELEGATES.AllocConsole), ref parameters);
            }

            //func wrapper for DynInv GetConsoleWindow
            public static IntPtr GetConsoleWindow()
            {
                object[] parameters = { };
                return (IntPtr)DynInv.DynamicAPIInvoke("kernel32.dll", "GetConsoleWindow", typeof(KER32_DELEGATES.GetConsoleWindow), ref parameters);
            }

            //function wrapper for DynInv GetCommandLine
            public static IntPtr GetCommandLine()
            {
                object[] parameters = { };
                return (IntPtr)DynInv.DynamicAPIInvoke("kernel32.dll", "GetCommandLineW", typeof(KER32_DELEGATES.GetCommandLineW),ref parameters);
            }

            //function wrapper for DynInv GetStandardHandle
            public static IntPtr GetStdHandle(int nStdHandle)
            {
                ...
                IntPtr hStdHandle = (IntPtr)DynInv.DynamicAPIInvoke(@"kernel32.dll", @"GetStdHandle", typeof(KER32_DELEGATES.GetStdHandle), ref funcargs);
                return hStdHandle;
            }
            ...
            public static IntPtr CreateNamedPipe(string lpName, Win32.Kernel32.PipeOpenModeFlags dwOpenMode, Win32.Kernel32.PipeModeFlags dwPipeMode, uint nMaxInstances, uint nOutBufferSize, uint nInBufferSize, uint nDefaultTimeOut, IntPtr lpSecurityAttributes)
            {
                // Craft an array for the arguments
                object[] funcargs =
                {
                ...
                IntPtr retValue = (IntPtr)DynInv.DynamicAPIInvoke(@"kernel32.dll", @"CreateNamedPipeW",
                    typeof(KER32_DELEGATES.CreateNamedPipeW), ref funcargs);
                return retValue;
            }
            ...
            public static IntPtr CreateFile([MarshalAs(UnmanagedType.LPTStr)] string lpFileName, [MarshalAs(UnmanagedType.U4)] Win32.Kernel32.EFileAccess dwDesiredAccess, [MarshalAs(UnmanagedType.U4)] Win32.Kernel32.EFileShare dwShareMode,  IntPtr lpSecurityAttributes, Win32.Kernel32.ECreationDisposition dwCreationDisposition, [MarshalAs(UnmanagedType.U4)] Win32.Kernel32.EFileAttributes dwFlagsAndAttributes, IntPtr hTemplateFile)
            {
                ...
                IntPtr retValue = (IntPtr)DynInv.DynamicAPIInvoke(@"kernel32.dll", @"CreateFileW",
                    typeof(KER32_DELEGATES.CreateFileW), ref funcargs);
                return retValue;
            }
            ...
            //func wrapper for static extern IntPtr ConnectNamedPipe(IntPtr pipe, IntPtr zero);
            public static bool ConnectNamedPipe(IntPtr pipe, IntPtr zero)
            {
                // Craft an array for the arguments
                object[] funcargs =
                {
                ...
                bool retValue = (bool)DynInv.DynamicAPIInvoke(@"kernel32.dll", @"ConnectNamedPipe", typeof(KER32_DELEGATES.ConnectNamedPipe), ref funcargs);
                return retValue;
            }
        }
        
        public class User32FuncWrapper
        {
            //func wrapper user32 for bool ShowWindow(IntPtr hWnd, int nCmdShow)
            public static bool ShowWindow(IntPtr hWnd, int nCmdShow)
            {
                ...
                bool retValue = (bool)DynInv.DynamicAPIInvoke(@"user32.dll", @"ShowWindow", typeof(USER32_DELEGATES.ShowWindow), ref funcargs);
                return retValue;
            }
        }

        public class UserenvFuncWrapper
        {
            //func wrapper for bool DeleteProfile(string lpSidString, string lpProfilePath, string lpComputerName)
            public static bool DeleteProfile(string lpSidString, string lpProfilePath, string lpComputerName)
            {
                ...
                bool retValue = (bool)DynInv.DynamicAPIInvoke(@"userenv.dll", @"DeleteProfile", typeof(USERENV_DELEGATES.DeleteProfile), ref funcargs);
                return retValue;
            }
        }
        ...
        public class AdvApi32FuncWrapper
        {
            ...
            //        bool retValue = (bool)DynInv.DynamicAPIInvoke(@"advapi32.dll", @"CreateProcessAsUserW", typeof(ADVAPI32_DELEGATES.CreateProcessAsUser), ref funcargs);
            //        lpProcessInformation = (Win32.ProcessThreadsAPI._PROCESS_INFORMATION)funcargs[10];
            //        return retValue;
            //    }
            //    catch (Exception ex)
            //    {
            //        Console.WriteLine($"error in CreateProcessAsUser: {ex.Message}");
            //        Console.WriteLine(Ker32FuncWrapper.GetLastError());
            //        lpProcessInformation = new Win32.ProcessThreadsAPI._PROCESS_INFORMATION();
            //        return false;
            //    }
                
            //}
            //func wrapper for bool CreateProcessAsUser(IntPtr hToken, string lpApplicationName, string lpCommandLine, IntPtr lpProcessAttributes, IntPtr lpThreadAttributes, bool bInheritHandles, int dwCreationFlags, IntPtr lpEnvironment, IntPtr lpCurrentDirectory, ref STARTUPINFO lpStartupInfo, out PROCESS_INFORMATION lpProcessInformation)
            ...
            //func wrapper for bool LookupPrivilegeValue(string lpSystemName, string lpName, ref Win32.WinNT._LUID lpLuid);
            public static bool LookupPrivilegeValue(string lpSystemName, string lpName, out Win32.WinNT._LUID lpLuid)
            {
                // Craft an array for the arguments
                lpLuid = new Win32.WinNT._LUID();
                object[] funcargs =
                {
                    lpSystemName, lpName, lpLuid
                };

                bool retValue = (bool)DynInv.DynamicAPIInvoke(@"advapi32.dll", @"LookupPrivilegeValueW", typeof(ADVAPI32_DELEGATES.LookupPrivilegeValue), ref funcargs);
                lpLuid = (Win32.WinNT._LUID)funcargs[2];
                return retValue;
            }

            //func wrapper for bool AdjustTokenPrivileges(IntPtr TokenHandle, bool DisableAllPrivileges, ref Win32.WinNT._TOKEN_PRIVILEGES NewState, uint BufferLength, IntPtr PreviousState, IntPtr ReturnLength);
            public static bool AdjustTokenPrivileges(IntPtr TokenHandle, bool DisableAllPrivileges, ref Win32.WinNT._TOKEN_PRIVILEGES NewState, int BufferLength, IntPtr PreviousState, IntPtr ReturnLength)
            {
                // Craft an array for the arguments
                object[] funcargs =
                {
                ...
                bool retValue = (bool)DynInv.DynamicAPIInvoke(@"advapi32.dll", @"AdjustTokenPrivileges", typeof(ADVAPI32_DELEGATES.AdjustTokenPrivileges), ref funcargs);
                return retValue;
            }
            ...
            //func wrapper for private static extern bool ImpersonateNamedPipeClient(IntPtr pipe);
            public static bool ImpersonateNamedPipeClient(IntPtr pipe)
            {
                // Craft an array for the arguments
                object[] funcargs =
                {
                ...
                bool retValue = (bool)DynInv.DynamicAPIInvoke(@"advapi32.dll", @"ImpersonateNamedPipeClient", typeof(ADVAPI32_DELEGATES.ImpersonateNamedPipeClient), ref funcargs);
                return retValue;
            }
